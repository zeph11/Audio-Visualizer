...
def main():
  ...
  """
    ...
    window = glfw.create_window(RESOLUTION, RESOLUTION, "Circle Drawing", None, None)
    ...
    temp = midPointCircle(0, 0, 70, RESOLUTION)
    ...
    print(temp)
    indices = np.array([i for i in range(1, len(vertices))], dtype=np.uint32)
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_TRUE, 0, ctypes.c_void_p(0))
